...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Client says: " + client.getGreeting() + "I live in " + client.getCity());
    ...
    public void logEvents(ApplicationContext ctx) {
        ...
        event = ctx.getBean(Event.class);
        logEvent(EventType.DEBUG, event, "Some event for DEBUG");

        event = ctx.getBean(Event.class);
        logEvent(EventType.WARNING, event, "Some event for WARNING");
    }
